...
import wandb
from algorithms.utils.architectures.open_llm_recurrent import recurrent_open_llm
...
def make_train(config):
    ...
    def train(function, rng):
        ...
        opt = recurrent_open_llm(function, config["RECUR_LR"]).opt_fn()
...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        config=config,
        name=f"eval_open_recurrent_llm",
    )
