...
from algorithms.utils.architectures.no_feat_ff import mlp_no_feat
...
def make_train(config):
    ...
    def train(meta_params, rng, grid_type=6):
        ...
        meta_opt = mlp_no_feat(hidden_size=config["HSIZE_OPTIM"])
...
if __name__ == "__main__":
    ...
    meta_opt = mlp_no_feat(hidden_size=args.hsize)
    ...
    for gen in tqdm(range(num_generations)):
        ...
        for env in args.envs:
            ...
            all_configs[env]["HSIZE_OPTIM"] = args.hsize
