...
from algorithms.utils.architectures.open_ff import mlp_open_ff
...
def make_train(config):
    ...
    def train(meta_params, rng, grid_type=6):
        ...
        meta_opt = mlp_open_ff(hidden_size=config["OPTIM_HSIZE"])
...
if __name__ == "__main__":
    ...
    save_loc = "save_files/open_ff_bb"
    ...
    meta_opt = mlp_open_ff(hidden_size=args.hsize)
    ...
    for gen in tqdm(range(num_generations)):
        ...
        for env in args.envs:
            ...
            all_configs[env]["OPTIM_HSIZE"] = args.hsize
