    ...
    def opt_fn(self) -> opt_base.Optimizer:
        ...
        class _Opt(opt_base.Optimizer):
            def init(
                ...
                rec_var = jax.tree_util.tree_map(jnp.zeros_like, params)
                return GRUOptState(
                    params=params,
                    state=model_state,
            ...
            def update(
                ...
                carry = {"actor": opt_state_actor.var, "critic": crit_opt_state.var}

                lr = lr_ * (1 - training_step_feature)
                t = opt_state_actor.iteration + 1

                def _update_tensor(p, g, mom, k, dorm, layer_prop, mask, carry):
                    ...
                    new_var = new_var.reshape(p.shape)
                    return (update, update, new_var)
